...
namespace ContatosApp.Presentation.Security
{
    public class TokenSecurity
    {
        ...
        #endregion
        ///<summary>
        ///Método para gerar um token jwt da API
        ///</summary>
        ///
